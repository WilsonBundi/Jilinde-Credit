package com.jilindecredit.api.config;

import com.jilindecredit.api.security.CustomUserDetailsService;
import com.jilindecredit.api.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/admin/**", "/admin/**").permitAll() // Temporarily allow admin endpoints for demo
